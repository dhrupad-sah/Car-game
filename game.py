"""
@author: Dhrupad, Anand, Vivek
@email: dhrupad.s21@iiits.in
"""
import random
...
class CarRacing:
    ...
    def restart_game(self):
        ...
        self.crashed = False
        self.count = 0
        self.run_car()  # Restart the game loop
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_RIGHT:
                        self.car_x_coordinate += 50
                        print("CAR X COORDINATES: %s" % self.car_x_coordinate)
                    elif event.key == pygame.K_SPACE:  # Check for space bar press
                        self.restart_game()  # Call restart_game method
    ...
    def highscore(self, count):
        ...
        # Display high score
        high_score_text = font.render("High Score : " + str(self.high_score), True, self.white)
        self.gameDisplay.blit(high_score_text, (self.display_width - high_score_text.get_width() - 10, 0))

    def display_credit(self):
        font = pygame.font.SysFont("lucidaconsole", 14)
        text = font.render("Thanks & Regards,", True, self.white)
        self.gameDisplay.blit(text, (600, 520))
        text = font.render("Dhrupad, Anand, Vivek", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("dhrupad.s21@iiits.in", True, self.white)
